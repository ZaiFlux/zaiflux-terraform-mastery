...
GitHub automatically detects workflow files placed inside the **workflows** directory.
...
- Create a workflow triggered on every push.
...
- Integrate TFLint.
- Add Checkov for security scanning.
- Generate a Terraform plan.
- Configure GitHub Secrets for AWS credentials.
- Add a protected environment with manual approval before deployment.
